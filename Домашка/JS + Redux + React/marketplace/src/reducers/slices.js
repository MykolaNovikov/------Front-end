...
// const address = 'http://marketplace.node.ed.asmer.org.ua/';
...
//                     adFind: builder.query({
//                         query: () => ({
//                             document: `query addList{
//                                             AdFind(query:"[{}]"){
//                                                 _id owner{login} images{url} title description tags address price
//                                             }
//                                             }`
//                         })
//                     }),
//                     AdFindOne: builder.query({
//                         query: ({_id}) => ({
//                             document: `query oneAd($query: String){
//                                     AdFindOne(query: $query){
//                                   _id owner{login avatar{url} nick} images{url} title description address price
//                                 }
//                               }`, variables: {query: JSON.stringify([{_id}])}
//                         })
//                     }),
...
//                     setUserAvatar: builder.mutation({
//                         query: ({id }) => ({
//                             document: `mutation setAvatar($id: String){
//                                             UserUpsert(user:{_id: $id}){
//                                                 _id{
//                                                     _id 
//                                                 }
//                                             }
...
// // Thunks and hooks
// const {useLoginMutation,useGetUserByIdQuery,useSetUserNickMutation,useAdFindQuery ,useSetUserAvatarMutation,useSetPasswordMutation,useUserRegistrationMutation} = api
